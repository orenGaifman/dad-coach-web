      ...
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow p-8">
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700">
            Dad Coach AI (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) is committed to protecting your privacy. 
            This Privacy Policy explains how we collect, use, and safeguard your information when you use our 
            WhatsApp-based coaching service.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <li>Messages you send to our service</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>To provide personalized parenting coaching</li>
            <li>To improve our AI responses</li>
            <li>To communicate with you via WhatsApp</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700">
            We retain your conversation data for the purpose of providing continuous coaching support. 
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700">
            ...
            Contact us at oren26g@gmail.com for any privacy-related requests.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700">
            For questions about this Privacy Policy, please contact us at: oren26g@gmail.com
          </p>
        </section>
      </div>
    </div>
